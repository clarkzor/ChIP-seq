...
for i in {1..2}; do   # adjust range as needed
  echo "Processing Replicate ${i}"

  ChIP_READ1=${RAW_DIR}/st9-Ezh2-Foxh1mut2-READ1_Replicate${i}.fastq
  ChIP_READ2=${RAW_DIR}/st9-Ezh2-Foxh1mut2-READ2_Replicate${i}.fastq
